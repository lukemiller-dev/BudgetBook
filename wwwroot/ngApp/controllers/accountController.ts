namespace newBudgetBook.Controllers {
    ...
    export class AccountController {
        ...
        constructor(private accountService: newBudgetBook.Services.AccountService, private $location: ng.ILocationService, public $state: ng.ui.IStateService, public $uibModal: ng.ui.bootstrap.IModalService, public ModalService: newBudgetBook.Services.ModalService) {
    ...
    angular.module('newBudgetBook').controller('AccountController', AccountController);
    ...
    angular.module('newBudgetBook').controller('LoginController', LoginController);
    ...
    export class ConfirmEmailController {
        ...
        constructor(
            private accountService: newBudgetBook.Services.AccountService,
